...
const LoginPage = ({ onLogin }) => {
    ...
    const API_URL = import.meta.env.VITE_API_URL || 'https://ceepee-backend.onrender.com/api/auth';
        ...
        <div className="login-container">
            ...
            >
                <motion.div variants={itemVariants} className="login-header">
                    ...
                    <p style={{ fontSize: '0.6rem', marginTop: '4px', letterSpacing: '2px', color: '#888' }}>SINCE 1980</p>
                </motion.div>
